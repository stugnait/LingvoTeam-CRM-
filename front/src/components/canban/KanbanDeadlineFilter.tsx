...
import { AlertCircle, Clock, CalendarDays, Calendar, Ban } from 'lucide-react';
            ...
            {PRESETS.map((preset) => {
                ...
                return (
                    ...
                    >
                        ...
                        <span className="hidden xs:inline sm:inline">{t(preset.labelKey)}</span>
                        <span className="xs:hidden sm:hidden">{t(preset.labelKey).split(' ')[0]}</span>
                        {count > 0 && (
                            <span className={cn(
