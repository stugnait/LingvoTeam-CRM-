...
import { User, Tag, Users, CalendarClock, MessageSquare, DollarSign } from "lucide-react"
...
export function CreateOrderModal(props: CreateOrderModalProps) {
  ...
  const {
    ...
    statsResult,
    statsLoading,
    analyzeOrderFiles, // NEW: now takes (files, sourceLanguageId?)
    analysisResult, // NEW: AnalyzeUploadedImagesResponse
    analysisLoading,
  } = useOrderAnalysis()
  ...
  const handleAnalyzeImages = async () => {
    ...
    // pass source language id so backend selects OCR lang
